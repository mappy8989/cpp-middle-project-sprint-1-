...
TEST(crypto_guard, decrypt_1) {
    const std::string test_str = "0123456789a0123456789b0123456789c0123456789d0123456789e0123456789f";
    ...
    std::string plain_string = plain_text.rdbuf()->str().substr(0, strlen(plain_text.rdbuf()->str().data()));

    EXPECT_EQ(test_str, plain_string);
}

TEST(crypto_guard, decrypt_2) {
    const std::string test_str = "012345678901234567890123456789012345678901234567890123456789";
    ...
    std::string plain_string = plain_text.rdbuf()->str().substr(0, strlen(plain_text.rdbuf()->str().data()));
    EXPECT_NE(test_str, plain_string);
}
